...
<Info>
  Note: this blog is part of a running series of the lessons I've learned from
  reading a thousand comics. If you're interested in the other posts, check them
  out [here](/blog/lessons-from-reading-a-thousand-comics)!
</Info>
