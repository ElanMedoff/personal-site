...
the second article's <Link href="">Bonus section</Link>, we'll discuss a hybrid approach to account
for os-level preferences using both cookies _and_ media queries.
...
So how can we prevent the dreaded flash? Keep reading in
