...
<Info>
  __Note__: Other approaches to CI frequently use a process that runs on a
  _remote_ machine, like Github actions or a Jenkins setup. These are great
  options for larger projects/companies, but in my opinion, a simple setup of
  running your build and tests locally before pushing to production works just
  fine.
</Info>
