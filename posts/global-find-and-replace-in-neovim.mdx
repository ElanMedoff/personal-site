...
abstract: "Stitching together the fzf, the quickfix list, cdo, and a custom lua function for an awesome find and replace in Neovim"
...
Find your first-pass results with [fzf-lua](https://github.com/ibhagwan/fzf-lua)/[telescope](https://github.com/nvim-telescope/telescope.nvim), populate them into the quickfix list, narrow it down with [bqf](https://github.com/kevinhwang91/nvim-bqf), and replace all instances by executing `cdo s/find/replace` with a custom user command to accept arguments for `find` and `replace`.
...
<Image src="/blog/grep-for.png" size="small"/>
...
<Image src="/blog/fzf-initial.png"/>
...
<Image src="/blog/bqf-initial.png" />

## Narrow Down With bqf

The second plugin we'll use is [bqf](https://github.com/kevinhwang91/nvim-bqf), an awesome utility for the quickfix list. I won't dive into all the details, but some of the highlights are:
...
<Info>
Note that to use `zf`, you'll need to install [fzf.vim](https://github.com/junegunn/fzf.vim). Thanks [evergreengt](https://www.reddit.com/r/neovim/comments/yq8ofh/comment/ivn8rzx/?utm_source=share&utm_medium=web2x&context=3) for pointing this out!
</Info>
