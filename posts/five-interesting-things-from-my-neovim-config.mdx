...
Although I'm no expert in NeoVim, I've found a few interesting solutions for the problems I've encountered when switching from VSCode to Vim. For those new and old to (Neo)Vim, I hope I can provide some value as you tinker with your own config with the following interesting tidbits.
