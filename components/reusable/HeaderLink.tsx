  ...
  return (
    <>
      ...
      >
        ...
        <h1 className={tm("cursor-pointer font-bold my-3 text-left inline mr-3", "text-xl md:text-2xl")} {...props} />
        <span
          className={tm(
      ...
      <Dialog id={modalSlug}>
        <Spacing vertical md data-testid={`copy-url-dialog-${hashSlug}`}>
          ...
          <p>If you disable this pop-up in the future, clicking on a header will copy the link to your clipboard.</p>
          ...
          <Spacing vertical xl>
            ...
            >
              <div
                className={tm("w-6 h-6 border-2 border-primary rounded-md", "hover:scale-90", checked && "bg-primary")}
                style={{
                  ...transitionProperties,
